  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto p-8">
        ...
        <p className="text-gray-700 text-lg mt-4">Whether you have a project in mind, a question about my work, or simply want to connect, I'm  open to new opportunities and collaborations.</p>
